...
[
    {
        ...
        "created_at": "2018-11-01 23:27:40",
        "updated_at": "2018-11-01 23:27:40"
    },
    {
        "id": 2,
        "name": "nome2",
    ...
    },
    {
        ...
        "email": "emanuel@mail",
        "email_verified_at": null,
        "created_at": "2018-11-01 23:27:41",
        "updated_at": "2018-11-01 23:27:41"
    }
]
```
...
```json
{
    ...
    "article": [
        {
            "id": 1,
            "title": "Titulo com img",
            "description": "Descricao2",
            "image": "\/opt\/lampp\/temp\/phpsWLOf0",
            "user_id": 1,
            "created_at": "2018-11-01 23:28:29",
            "updated_at": "2018-11-01 23:28:29"
        }
    ]
}
```
...
<!-- START_3f90b8f8d469855cdbb0e17891a6a7ec -->
## Show the form for creating a new resource.

> Example request:

```bash
curl -X GET -G "http://localhost/api/article/create" 
```
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://localhost/api/article/create",
    "method": "GET",
    "headers": {
    }
}
...
<!-- END_3f90b8f8d469855cdbb0e17891a6a7ec -->
...
<!-- START_594c8d6dd639a9e4b5e039d4a4b916c3 -->
## Show the form for editing the specified resource.

> Example request:

```bash
curl -X GET -G "http://localhost/api/article/{article}/edit" 
```
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://localhost/api/article/{article}/edit",
    "method": "GET",
    "headers": {
    }
}
...
### HTTP Request
`GET api/article/{article}/edit`


<!-- END_594c8d6dd639a9e4b5e039d4a4b916c3 -->
...
[
    {
        "id": 1,
        "commentText": "comentario mt grnade",
        "user_id": 1,
        "article_id": 1,
        "created_at": "2018-11-01 23:38:00",
        "updated_at": "2018-11-01 23:38:00"
    }
]
```
...
<!-- START_2ebe6dd53216538cdda886417bad117b -->
## Show the form for creating a new resource.

> Example request:

```bash
curl -X GET -G "http://localhost/api/comment/create" 
```
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://localhost/api/comment/create",
    "method": "GET",
    "headers": {
    }
}
...
### HTTP Request
`GET api/comment/create`


<!-- END_2ebe6dd53216538cdda886417bad117b -->
...
<!-- START_74d28e92976357495795d907343ceb65 -->
## Show the form for editing the specified resource.

> Example request:

```bash
curl -X GET -G "http://localhost/api/comment/{comment}/edit" 
```
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://localhost/api/comment/{comment}/edit",
    "method": "GET",
    "headers": {
    }
}
...
### HTTP Request
`GET api/comment/{comment}/edit`


<!-- END_74d28e92976357495795d907343ceb65 -->
